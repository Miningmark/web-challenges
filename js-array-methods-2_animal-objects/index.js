...
const firstAnimalStartingWithLetterG = animals.find((animale) => animale.name.startsWith("g"));
...
const weightOfAllAnimalsInAfrica = animals.filter((animal) => animal.continents.includes("Africa")).reduce((totalWeight, animal) => totalWeight += animal.weight, 0);
...
const averageWeightOfAllAnimalsInAfrica = animals.filter((animal) => animal.continents.includes("Africa")).reduce((totalWeight, animal) => totalWeight += animal.weight, 0) / animals.filter((animal) => animal.continents.includes("Africa")).length;
