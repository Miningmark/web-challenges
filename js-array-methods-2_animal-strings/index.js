...
const everyAnimalHasMoreThanTwoLetters = animalStrings.every((animale) => animale.length > 2);
...
const sumOfAllAnimalCharacters = animalStrings.reduce((accumulator, animale) => accumulator += animale.length, 0);
